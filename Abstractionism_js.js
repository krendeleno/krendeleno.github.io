$(function () {
    ...
    function close() {
        $("#" + n + " .modal-content").addClass("animate__zoomOut");
        $("#" + n + " .modal-content").removeClass("animate__zoomIn");
        $("#" + n + " .modal-content").removeClass("animate__fadeIn");
        $("#" + n).removeClass("animate__fadeIn");
        $("#" + n).addClass("animate__fadeOut");
